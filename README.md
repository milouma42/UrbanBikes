...
🎯 Projektziel
Das Ziel war es, herauszufinden, warum Bestellungen bei UrbanBikes zu lange dauern ("Order-to-Ship-Time"). Dafür wurden Log-Daten aus dem ERP- und Lagersystem mittels Python und Process Mining analysiert, Engpässe identifiziert und eine SQL-Datenbank aufgebaut.
...
Hier ist eine kurze Erklärung der wichtigsten Dateien:
...
👤 Autor
Michelle Louise Martin Fachinformatikerin für Daten- und Prozessanalyse
